    ...
    return (
        <header className="headerPlatform">
            <div className="container">
                ...
                {
                    !window.location.href.includes('chat') && !window.location.href.includes('myProfile') && !window.location.href.includes('tasks') && !window.location.href.includes('create_task')
